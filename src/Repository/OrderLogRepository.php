 ...
 */
#[AsRepository(entityClass: OrderLog::class)]
final class OrderLogRepository extends ServiceEntityRepository
{
     ...
     * 保存实体
     */
    public function save(OrderLog $entity, bool $flush = true): void
    {
